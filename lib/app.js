...
app.connect = function (callback) {
  ...
  logger = process.env.JSBIN_LOGGER || app.get('server logger') || 'combined';
  ...
  store.connect(function (err) {
    ...
    app.listen(process.env.PORT || port, options.host);	// options.host can be empty, meaning "bind to all network interfaces"
